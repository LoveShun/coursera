...
z3 = [ones(m,1), a2]*Theta2';   % 5000*26    26*10   --> z3 = 5000*10
...
for i = 1:m
    ...
    Theta2_grad = Theta2_grad + delta3*[1; a2_]';    % 10*1  1*(25+1)   =  10*(25+1)
    Theta1_grad = Theta1_grad + delta2(2:end)*[1;a1_]';  % 25*1  1*(400+1)  = 25*(400+1)
end
